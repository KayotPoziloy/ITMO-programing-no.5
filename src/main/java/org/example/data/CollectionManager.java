...
public class CollectionManager {
     ...
     */
    public void info() {
        System.out.println("Тип коллекции: " + humanBeingArrayDeque.getClass().getName());
        System.out.println("Тип элементов коллекции: " + HumanBeing.class.getName());
        System.out.println("Дата инициализации коллекции: " + initializationDate);
        System.out.println("Количество элементов в коллекции: " + humanBeingArrayDeque.size());
    }
