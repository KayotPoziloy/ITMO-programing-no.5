...
/**
 * Класс команды, которая добавляет новый объект HumanBeing, если его ImpactSpeed наибольший
 */
public class AddIfMaxCommand implements Command {
     ...
     */
    public AddIfMaxCommand(HumanBeingReader humanBeingReader, CollectionManager collectionManager) {
    ...
    public void execute() {
        try {
            ...
            HumanBeing maxHuman = collectionManager.getMaxByImpactSpeed();
            if (maxHuman == null || newHuman.getImpactSpeed() > maxHuman.getImpactSpeed()) {
    ...
    public String getDescription() {
        return "создает новый объект HumanBeing, если его ImpactSpeed наибольший";
    }
}